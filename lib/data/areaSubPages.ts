...
export const areaSubPages: AreaSubPage[] = [
  ...
  // Katsushika additional slugs
  {
    area: "katsushika",
    slug: "seo",
    title: "葛飾区のSEO対策",
    titleEn: "Katsushika SEO",
    metaDescription: "葛飾区のSEO対策専門ページ。亀有・金町・水元・柴又エリアで「葛飾区＋業種名」の検索上位表示を実現し、Webからの集客を強化します。",
    intro: "葛飾区は亀有・金町・水元・柴又・新小岩など複数のエリアに分散して人口が密集しています。「葛飾区＋業種名」「亀有＋業種名」等のキーワードでSEO上位表示を実現し、葛飾区内の見込み客を自社サイトへ集客します。",
    points: [
      { num: "01", title: "「葛飾区＋業種名」キーワードでの上位表示", body: "「葛飾区 税理士」「葛飾区 リフォーム」「亀有 不動産」等のローカルSEOキーワードで上位表示を目指します。" },
      { num: "02", title: "葛飾区の地域特性を活かしたコンテンツ", body: "葛飾区の歴史・生活文化・住民特性（子育て世帯が多い等）を反映した地域密着コンテンツで、地元ユーザーの信頼を獲得します。" },
    ],
    faqs: [
      { q: "葛飾区のSEO対策は東京都心と比べて取り組みやすいですか？", a: "はい。葛飾区は東京23区の中でも競合が比較的少なく、ローカルSEOに取り組むことで早期に上位表示できる可能性が高いエリアです。" },
    ],
    related: [
      { href: "/area/katsushika", label: "葛飾区の集客支援", desc: "葛飾区全体" },
      { href: "/services/seo", label: "SEO対策サービス", desc: "検索上位表示" },
  ...
  },
  {
    ...
    title: "葛飾区のホームページ制作",
    titleEn: "Katsushika Web Design",
    metaDescription: "葛飾区のホームページ制作。葛飾区・亀有・金町・水元・新小岩エリアの中小企業・店舗向けにSEO対策済みのホームページを制作します。",
    intro: "葛飾区の中小企業・店舗向けに、SEO・MEO・スマホ対応を標準装備したホームページを制作します。葛飾区内の競合状況を踏まえた集客特化サイト設計を提供します。",
    points: [
      { num: "01", title: "葛飾区の地域特性に合わせたサイト設計", body: "葛飾区は子育て世帯・定住意向の強い住民が多い特性があります。地域コミュニティへの訴求と口コミ重視の設計が効果的です。" },
      { num: "02", title: "MEOとの連携設計", body: "GBPとサイトの連携・LocalBusinessスキーマ・NAP情報統一で、Googleマップとウェブ検索の両方からの集客を実現します。" },
    ],
    faqs: [
      { q: "葛飾区でホームページを制作してもらいたいのですが、直接打ち合わせは可能ですか？", a: "通常はオンライン（Zoom等）でのご相談に対応しています。葛飾区に拠点があるため、ご要望に応じて対面でのご相談も可能です。まずはお問い合わせください。" },
    ],
    related: [
      { href: "/area/katsushika", label: "葛飾区の集客支援", desc: "葛飾区全体" },
      { href: "/services/web-design", label: "ホームページ制作", desc: "制作サービス詳細" },
