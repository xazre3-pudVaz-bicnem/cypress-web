            ...
            {[
              ...
              },
              {
                ...
                items: [
                  ...
                  { href: "/column/katsushika-yakiniku-shukyaku", label: "焼肉店の集客" },
                  { href: "/column/katsushika-sushi-shukyaku", label: "寿司店の集客" },
                  { href: "/column/katsushika-chuka-shukyaku", label: "中華料理店の集客" },
                  { href: "/column/katsushika-teishokuya-shukyaku", label: "定食屋・食堂の集客" },
                  { href: "/column/katsushika-cake-patisserie", label: "ケーキ屋・パティスリーの集客" },
                  { href: "/column/katsushika-shokuhin-kouri", label: "米屋・青果店・鮮魚店の集客" },
                  { href: "/column/katsushika-shoten-bunbougu", label: "書店・文房具店の集客" },
                  { href: "/column/katsushika-recycle-kaitori", label: "リサイクルショップ・買取店" },
                  { href: "/column/katsushika-futon-shingu", label: "布団店・寝具店の集客" },
                  { href: "/column/katsushika-kagu-interior", label: "家具店・インテリアショップ" },
                  { href: "/column/katsushika-gaiheki-tosou", label: "外壁塗装専門店の集客" },
                  { href: "/column/katsushika-gaichuu-kujo", label: "シロアリ・害虫駆除の集客" },
                  { href: "/column/katsushika-bousui-amamori", label: "防水工事・雨漏り修理" },
                  { href: "/column/katsushika-aircon-kyuutouki", label: "エアコン工事・給湯器交換" },
                  { href: "/column/katsushika-kitchen-reform", label: "キッチンリフォーム専門店" },
                ],
              },
              {
                group: "医療・専門サービスの集客",
                items: [
                  { href: "/column/katsushika-ganka-shukyaku", label: "眼科の集患" },
                  { href: "/column/katsushika-hifuka-shukyaku", label: "皮膚科の集患" },
                  { href: "/column/katsushika-shinryonaika-shukyaku", label: "精神科・心療内科の集患" },
                  { href: "/column/katsushika-doubutsu-byoin", label: "動物病院の集患" },
                  { href: "/column/katsushika-shinkyuin-shukyaku", label: "鍼灸院の集客" },
                  { href: "/column/katsushika-bengoshi-shukyaku", label: "弁護士事務所の集客" },
                  { href: "/column/katsushika-chiropractic-shukyaku", label: "カイロプラクティックの集客" },
                  { href: "/column/katsushika-datsumou-salon", label: "脱毛サロンの集客" },
                  { href: "/column/katsushika-barber-mens-biyou", label: "メンズ美容室・バーバー" },
                  { href: "/column/katsushika-kagiya-shukyaku", label: "鍵屋・鍵交換業者の集客" },
                  { href: "/column/katsushika-jinzai-haken", label: "人材紹介・派遣会社の集客" },
                  { href: "/column/katsushika-office-seisou", label: "オフィス清掃業の集客" },
                  { href: "/column/katsushika-hoken-dairiten", label: "保険代理店の集客" },
                  { href: "/column/katsushika-jutaku-loan-fp", label: "住宅ローン相談・FPの集客" },
                  { href: "/column/katsushika-boseki-sekizaiten", label: "墓石店・石材店の集客" },
                  { href: "/column/katsushika-bridal-photo-wedding", label: "フォトウェディングの集客" },
                  { href: "/column/katsushika-karaoke-shukyaku", label: "カラオケ店の集客" },
                  { href: "/column/katsushika-sento-onyoku", label: "スーパー銭湯・温浴施設" },
                  { href: "/column/katsushika-tennis-school", label: "テニススクールの集客" },
                  { href: "/column/katsushika-swimming-school", label: "スイミングスクールの集客" },
                  { href: "/column/katsushika-golf-school", label: "ゴルフスクールの集客" },
                  { href: "/column/katsushika-yobikou-daigaku-juken", label: "予備校・大学受験専門塾" },
                  { href: "/column/katsushika-shikaku-school", label: "資格スクールの集客" },
                  { href: "/column/katsushika-pet-hotel", label: "ペットホテルの集客" },
                  { href: "/column/katsushika-pc-shuuri-support", label: "パソコン修理・ITサポート" },
                ],
              },
              {
                group: "エリア・駅別の集客戦略",
                items: [
                  ...
                  { href: "/column/katsushika-yotsugi-meo-shukyaku", label: "四つ木・東四つ木の集客" },
                  { href: "/column/katsushika-niijuku-okudo-meo", label: "新宿(にいじゅく)・奥戸の集客" },
                  { href: "/column/katsushika-mizumoto-meo-shukyaku", label: "水元・西水元の集客" },
                ],
              },
              {
                group: "施策別の実践ノウハウ",
                items: [
                  ...
                  { href: "/column/katsushika-google-ads-nyumon", label: "Google広告（リスティング）入門" },
                  { href: "/column/katsushika-sns-ads-nyumon", label: "SNS広告入門ガイド" },
                  { href: "/column/katsushika-multi-channel-senryaku", label: "複数チャネル戦略でリスク分散" },
                  { href: "/column/katsushika-gbp-zokusei-guide", label: "GBP「属性」設定完全ガイド" },
                  { href: "/column/katsushika-claim-taiou-enjou-boushi", label: "クレーム対応・炎上防止ガイド" },
                  { href: "/column/katsushika-tenpo-tenkai-fc", label: "多店舗展開・フランチャイズ化" },
                  { href: "/column/katsushika-gbp-qanda-katsuyou", label: "GBP「Q&A」機能活用ガイド" },
                ],
              },
              {
                group: "比較・課題解決",
