  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "MEO対策の効果が出るまでどのくらいかかりますか？", "acceptedAnswer": { "@type": "Answer", "text": "競合状況・エリア・業種によって異なりますが、Googleビジネスプロフィールの基本最適化は2〜4週間で効果が現れることがあります。安定した上位表示には3〜6ヶ月の継続的な取り組みが必要です。口コミ獲得・投稿継続・情報更新を組み合わせることで改善が加速します。" } },
        { "@type": "Question", "name": "MEO対策は自分でできますか？", "acceptedAnswer": { "@type": "Answer", "text": "Googleビジネスプロフィールの基本設定は自分で行えます。ただし、競合分析・キーワード設計・口コミ獲得の仕組み化・継続的な最適化は専門知識と時間が必要です。競合が多い都市部や業種では、専門家のサポートが成果を大幅に加速させます。" } },
        { "@type": "Question", "name": "飲食店以外でもMEO対策は有効ですか？", "acceptedAnswer": { "@type": "Answer", "text": "はい、MEO対策はGoogleマップで検索される業種すべてに有効です。美容室・整骨院・歯科・クリニック・不動産・リフォーム・士業・小売店など、地域に根差したビジネスであれば業種を問わず高い効果が期待できます。" } },
        { "@type": "Question", "name": "複数の店舗がある場合、まとめて対応できますか？", "acceptedAnswer": { "@type": "Answer", "text": "はい、複数店舗の一括管理に対応しています。Googleビジネスプロフィールマネージャーを活用した多店舗管理と、店舗ごとの個別最適化を組み合わせて対応します。規模に応じた多店舗プランをご用意しています。" } },
        { "@type": "Question", "name": "口コミが少ない・悪い場合はどうすればいいですか？", "acceptedAnswer": { "@type": "Answer", "text": "口コミが少ない場合は、来店後のお礼メッセージ・QRコードの設置・予約完了メールなど自然な導線から口コミをお願いする仕組みを構築します。ネガティブ口コミへは誠実な返信が重要で、適切な対応が他のユーザーへの信頼性向上にもつながります。口コミ取得を促進する不正な方法（金品提供・サクラ等）は規約違反となるため厳禁です。" } },
        { "@type": "Question", "name": "Googleマップの「ローカルパック」とは何ですか？", "acceptedAnswer": { "@type": "Answer", "text": "「渋谷 美容室」のように地域名＋業種で検索した際に、通常の検索結果より上部に地図と3件の店舗情報が表示されるエリアのことです。このローカルパックはクリック率が非常に高く、上位3件に入ることで来店数が大きく増加します。MEO対策の主要な目標はこのローカルパック上位表示です。" } },
        { "@type": "Question", "name": "MEO対策でどのくらい集客が増えますか？", "acceptedAnswer": { "@type": "Answer", "text": "効果は競合状況・エリア・業種・現状の最適化度によって大きく異なります。ローカルパック上位3件に入ると、現在より大幅にインプレッション数と来店数が増えるケースがあります。成果保証はできませんが、当社では現状診断を元に具体的な改善見込みをご説明します。" } },
        { "@type": "Question", "name": "Googleビジネスプロフィールは無料ですか？", "acceptedAnswer": { "@type": "Answer", "text": "はい、Googleビジネスプロフィールの登録・管理は基本的に無料です。ただし、適切に最適化するためには専門知識と継続的な運用工数が必要であり、多くの企業が支援サービスを活用しています。" } },
        { "@type": "Question", "name": "MEO対策費用の相場はいくらですか？", "acceptedAnswer": { "@type": "Answer", "text": "一般的なMEO対策の月次費用は、基本管理プランで月2〜5万円程度、競合が激しいエリア・業種での本格的な施策では月5〜15万円程度が相場です。初期設定費用が別途かかる場合もあります。サイプレスでは現状診断後に最適なプランをご提案します。" } },
        { "@type": "Question", "name": "MEO対策とSNSを同時に進めるべきですか？", "acceptedAnswer": { "@type": "Answer", "text": "はい、MEO対策とInstagram・X（Twitter）などのSNS運用を連動させることで集客効果が倍増します。InstagramでUGC（ユーザー投稿）を増やすことでGoogleでの口コミ・評判情報も充実し、MEO順位にも好影響を与えます。SNS投稿のコンテンツをGBP投稿にも流用する効率化も有効です。" } },
        { "@type": "Question", "name": "競合他社がすでにMEO対策をしている場合、勝てますか？", "acceptedAnswer": { "@type": "Answer", "text": "競合が既に実施している場合でも、徹底した最適化・口コミ獲得の加速・地域キーワード設計の差別化によって逆転は可能です。競合分析を詳細に行い、競合の弱点を突く施策を組み立てることが重要です。当社では競合分析レポートを元にした差別化戦略をご提案します。" } },
        { "@type": "Question", "name": "Googleビジネスプロフィールの「投稿」機能はMEOに効果がありますか？", "acceptedAnswer": { "@type": "Answer", "text": "はい、GBP投稿は情報鮮度のシグナルとしてMEO順位に貢献します。週1〜2回のペースでキャンペーン・最新情報・お知らせを投稿することで、Googleにビジネスの活発さを伝えられます。写真付き・CTA（ボタン）付きの投稿は来店・問い合わせへの直接的な導線にもなります。" } },
        { "@type": "Question", "name": "NAP情報（名前・住所・電話番号）の一貫性はなぜ重要ですか？", "acceptedAnswer": { "@type": "Answer", "text": "GoogleはWebサイト・GBP・各ポータルサイト・SNSなど複数のソースで自社情報を照合しています。名前・住所・電話番号（NAP情報）に不一致があると、情報の信頼性が低いと評価されMEO順位に悪影響を与えます。全プラットフォームでNAPを統一することがMEO対策の基本です。" } },
        { "@type": "Question", "name": "Googleマップへの写真投稿はMEO対策に関係しますか？", "acceptedAnswer": { "@type": "Answer", "text": "はい、写真の数・質・更新頻度はMEO順位の評価要素の一つです。外観・内装・スタッフ・商品・サービスシーンなど多様な写真を定期的に投稿することで、知名度スコアが向上します。ユーザーが投稿した写真（UGC）も評価されるため、来店客に写真投稿を促す施策も有効です。" } },
        { "@type": "Question", "name": "MEO対策とホームページSEOを連携させる方法はありますか？", "acceptedAnswer": { "@type": "Answer", "text": "はい、連携は非常に重要です。GBPにウェブサイトURLを設定し、ウェブサイトのトップページ・会社概要ページでLocalBusiness構造化データを実装することで、GoogleがGBPとWebサイトの情報を関連付けやすくなります。また、対応エリアページや業種特化ページへのリンクをGBPから張ることも効果的です。" } },
        { "@type": "Question", "name": "Googleビジネスプロフィールのペナルティとはどんなものですか？", "acceptedAnswer": { "@type": "Answer", "text": "GBPのペナルティには、サービスエリアのみのビジネスが実際の住所を表示している違反、虚偽の口コミ操作、実在しないビジネスの登録、業種と異なるカテゴリ設定などが含まれます。ペナルティを受けるとリスティングが非表示・削除されます。Googleのポリシーを遵守した運用が最も安全です。" } },
        { "@type": "Question", "name": "MEO対策の効果測定はどのように行いますか？", "acceptedAnswer": { "@type": "Answer", "text": "Googleビジネスプロフィールのインサイト機能で、検索インプレッション数・地図表示回数・電話クリック数・ルート検索数・ウェブサイトクリック数を確認できます。さらに順位計測ツールで対策キーワードのローカルパック順位を定期追跡し、PDCAを回します。" } },
        { "@type": "Question", "name": "口コミへの返信はMEO順位に影響しますか？", "acceptedAnswer": { "@type": "Answer", "text": "Googleは全ての口コミに返信することを推奨しており、返信率もMEO評価に影響するとされています。特にポジティブ口コミへの感謝・ネガティブ口コミへの誠実な対応は、他のユーザーへの信頼性向上にもつながります。返信は24〜48時間以内が理想です。" } },
        { "@type": "Question", "name": "医療機関のMEO対策で注意すべき点はありますか？", "acceptedAnswer": { "@type": "Answer", "text": "医療機関のGBPは「医療広告ガイドライン」の対象となります。効果を保証する表現・比較広告・医師法に触れる情報の掲載は禁止されています。また、予約機能・診療時間・保険対応情報などを正確に設定することが患者獲得に重要です。専門家のサポートのもと、適法なMEO対策を実施することを推奨します。" } },
      ],
    },
  ],
};
...
const faqItems = [
  ...
  {
    q: "Googleビジネスプロフィールの「投稿」機能はMEOに効果がありますか？",
    a: "はい、GBP投稿は情報鮮度のシグナルとしてMEO順位に貢献します。週1〜2回のペースでキャンペーン・最新情報・お知らせを投稿することで、Googleにビジネスの活発さを伝えられます。写真付き・CTA（ボタン）付きの投稿は来店・問い合わせへの直接的な導線にもなります。",
  },
  {
    q: "NAP情報（名前・住所・電話番号）の一貫性はなぜ重要ですか？",
    a: "GoogleはWebサイト・GBP・各ポータルサイト・SNSなど複数のソースで自社情報を照合しています。名前・住所・電話番号（NAP情報）に不一致があると、情報の信頼性が低いと評価されMEO順位に悪影響を与えます。全プラットフォームでNAPを統一することがMEO対策の基本です。",
  },
  {
    q: "Googleマップへの写真投稿はMEO対策に関係しますか？",
    a: "はい、写真の数・質・更新頻度はMEO順位の評価要素の一つです。外観・内装・スタッフ・商品・サービスシーンなど多様な写真を定期的に投稿することで、知名度スコアが向上します。ユーザーが投稿した写真（UGC）も評価されるため、来店客に写真投稿を促す施策も有効です。",
  },
  {
    q: "MEO対策とホームページSEOを連携させる方法はありますか？",
    a: "はい、連携は非常に重要です。GBPにウェブサイトURLを設定し、ウェブサイトのトップページ・会社概要ページでLocalBusiness構造化データを実装することで、GoogleがGBPとWebサイトの情報を関連付けやすくなります。また、対応エリアページや業種特化ページへのリンクをGBPから張ることも効果的です。",
  },
  {
    q: "MEO対策の効果測定はどのように行いますか？",
    a: "Googleビジネスプロフィールのインサイト機能で、検索インプレッション数・地図表示回数・電話クリック数・ルート検索数・ウェブサイトクリック数を確認できます。さらに順位計測ツールで対策キーワードのローカルパック順位を定期追跡し、PDCAを回します。",
  },
  {
    q: "口コミへの返信はMEO順位に影響しますか？",
    a: "Googleは全ての口コミに返信することを推奨しており、返信率もMEO評価に影響するとされています。特にポジティブ口コミへの感謝・ネガティブ口コミへの誠実な対応は、他のユーザーへの信頼性向上にもつながります。返信は24〜48時間以内が理想です。",
  },
  {
    q: "医療機関のMEO対策で注意すべき点はありますか？",
    a: "医療機関のGBPは「医療広告ガイドライン」の対象となります。効果を保証する表現・比較広告・医師法に触れる情報の掲載は禁止されています。また、予約機能・診療時間・保険対応情報などを正確に設定することが患者獲得に重要です。専門家のサポートのもと、適法なMEO対策を実施することを推奨します。",
  },
];
