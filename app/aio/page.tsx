...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "AIO対策とSEO対策は何が違いますか？", "acceptedAnswer": { "@type": "Answer", "text": "SEO対策がGoogleなどの検索エンジンの順位改善を目的とするのに対し、AIO対策はChatGPT・Gemini・Perplexityなどの生成AIが質問に回答する際に自社情報を引用・推薦するよう最適化します。" } },
        { "@type": "Question", "name": "AIO対策の効果はどのように計測しますか？", "acceptedAnswer": { "@type": "Answer", "text": "業界関連クエリをAIに投げて自社が引用されるかを定期チェックする「引用率テスト」、指名検索数の推移、AI経由の問い合わせ数などを計測します。" } },
        { "@type": "Question", "name": "AIO対策はどのような業種に有効ですか？", "acceptedAnswer": { "@type": "Answer", "text": "サービス業・専門職・B2B企業・コンサルティング業など、AIに推薦されることが集客に直結する業種は特に優先度が高いです。" } },
      ],
    },
  ],
};
