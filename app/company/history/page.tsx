...
const HISTORY = [
  ...
  },
  {
    ...
    body: "ChatGPT・Gemini・Perplexityなど、AI検索エンジンからの引用・回答表示を狙ったAIO（AI最適化）対策サービスの提供を開始。構造化データ・FAQ設計・E-E-A-T強化を柱とした支援メソッドを確立。",
  },
  {
    date: "2026年6月",
    title: "ホームページ制作・SNS運用・AI活用支援サービス開始",
    body: "集客設計を起点とした、表示速度・SEO・モバイル対応を兼ね備えたホームページ制作サービス、SNS運用代行サービス、AI業務効率化支援サービスを順次提供開始。",
  },
  {
    date: "2026年6月",
    title: "公式サイト・コラムページを公開",
    body: "株式会社サイプレスの公式サイトを公開。MEO・SEO・AIO・ホームページ制作など各サービスの専門知識コラムページを整備し、情報発信を本格化。",
  },
];
