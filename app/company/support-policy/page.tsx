...
const faqItems = [
  ...
  {
    q: "複数サービスを契約している場合、レポートはまとまりますか？",
    a: "はい。MEO・SEO・SNS・Web制作など複数のサービスをご契約の場合は、統合レポートでまとめてお送りします。各施策の相互影響も分析し、トータルの集客状況をわかりやすくお伝えします。",
  },
  {
    q: "スタート後、何から始まりますか？",
    a: "契約後、まず現状診断（ヒアリング・ツール設定確認・競合分析）を行い、優先施策を整理します。通常1〜2週間でキックオフMTGを実施し、3ヶ月・6ヶ月のロードマップをご提案します。",
  },
  {
    q: "月次レポートはどんな形式で届きますか？",
    a: "PDFまたはGoogleスプレッドシートで提供します。数値のグラフ・施策実施内容の記録・翌月の提案が1枚にまとまった見やすいフォーマットです。リアルタイム確認にはGA4・Search Console・GBPへのアクセス権をお渡しします。",
  },
  {
    q: "メールやLINEで気軽に質問してもいいですか？",
    a: "はい、歓迎しています。施策に関する疑問・口コミ対応の相談・ライバルが気になる場合など、日常的な質問もお気軽にどうぞ。原則24時間以内（土日は翌営業日）に返信します。",
  },
];
