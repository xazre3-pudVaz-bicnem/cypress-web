...
const faqItems = [
  ...
  {
    q: "成果保証はしていないとのことですが、成果が出なかった場合はどうなりますか？",
    a: "Googleのアルゴリズムは非公開で変動するため特定の成果保証はできません。ただし成果が出ない場合は原因を分析し、施策の見直しや対象キーワード・エリアの変更など、改善策を継続的に提案します。",
  },
  {
    q: "「誇大表現を使わない」とはどういう意味ですか？",
    a: "根拠のないNo.1表現・実績数の水増し・必ず効果が出るなどの保証表現は一切行いません。現実的な効果の見通しと、達成に向けた具体的な施策をお伝えすることで、お客様が判断できる情報を提供します。",
  },
  {
    q: "どのような企業や事業者を主な支援対象としていますか？",
    a: "飲食店・美容室・クリニック・整体院・工務店・士業・小売店など、地域密着型の中小企業・個人事業主を主な支援対象としています。MEO・SEO・SNS・Web制作など、Web集客全般のご支援が可能です。",
  },
  {
    q: "企業理念は実際の業務にどう反映されていますか？",
    a: "月次レポートの透明な情報開示、施策変更時の丁寧な説明、口コミ獲得での適法な手法の徹底、成果が出ない場合の素直な報告と代替提案など、日々の業務の判断基準が企業理念に基づいています。",
  },
  {
    q: "どのような基準でサービスの提供を断ることがありますか？",
    a: "過大な成果を期待している場合、Googleガイドライン違反の施策を求められる場合、お客様のビジネスや業種がサービスに合わないと判断した場合などは、誠実にお断りすることがあります。長期的なご関係を前提にご支援しています。",
  },
];
...
const relatedLinks = [
  ...
  { href: "/services/meo", label: "MEO対策", desc: "Googleマップ集客支援" },
  { href: "/services/seo", label: "SEO対策", desc: "検索上位表示支援" },
  { href: "/services/web-design", label: "Web制作", desc: "成果につながるサイト制作" },
