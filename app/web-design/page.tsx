...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "FAQPage",
      mainEntity: [
        { "@type": "Question", name: "Webサイト制作の費用相場はどのくらいですか？", acceptedAnswer: { "@type": "Answer", text: "シンプルなコーポレートサイト（5〜10ページ）で50〜150万円、SEO特化サイト・採用サイトで100〜300万円、EC機能付きサイトで200万円〜が一般的な相場です。フリーランスへの依頼は30〜80万円と安価ですが、品質・保守体制に差があります。" } },
        { "@type": "Question", name: "Next.jsとWordPressのどちらがいいですか？", acceptedAnswer: { "@type": "Answer", text: "Next.jsは表示速度・セキュリティ・SEOパフォーマンスに優れますが、更新にエンジニアが必要です。WordPressは管理画面から誰でも更新できますが、プラグインの脆弱性リスクがあります。更新頻度・社内体制・予算によって最適な選択が異なります。" } },
      ],
    },
  ],
};
