...
const faqItems = [
  ...
  {
    q: "ホームページの制作期間はどのくらいですか？顧客への説明は？",
    a: "規模や要件によって異なりますが、標準的なコーポレートサイトで約4〜8週間が目安です。顧客への提案時はサイプレスの担当者から詳細な工程をご説明します。",
  },
  {
    q: "顧客が自分でホームページの内容を更新できますか？",
    a: "はい。WordPressで構築する場合、顧客がログインして記事・情報を自分で更新できます。管理画面の操作方法についてもサイプレスがレクチャーします。",
  },
  {
    q: "一人（個人・フリーランス）で代理店活動できますか？",
    a: "はい。法人だけでなく個人事業主・副業での参加も相談可能です。既存の顧客接点や人脈を活かして販売できれば参加いただけます。まずはお問い合わせください。",
  },
];
