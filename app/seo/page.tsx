  ...
  "@graph": [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { "@type": "Question", name: "モバイル対応はSEOに影響しますか？", acceptedAnswer: { "@type": "Answer", text: "はい、Googleはモバイルファーストインデックスを採用しており、スマートフォンでの表示・速度・使いやすさがSEO評価の基本になっています。Core Web Vitals（LCP・CLS・FID）の改善もモバイル環境が評価の中心です。スマホ対応が不十分なサイトはPC表示が良くても評価が下がるリスクがあります。" } },
...
const faqItems = [
  ...
  {
    q: "モバイル対応はSEOに影響しますか？",
    a: "はい、Googleはモバイルファーストインデックスを採用しており、スマートフォンでの表示・速度・使いやすさがSEO評価の基本になっています。Core Web Vitals（LCP・CLS・FID）の改善もモバイル環境が評価の中心です。スマホ対応が不十分なサイトはPC表示が良くても評価が下がるリスクがあります。",
  },
  {
    q: "被リンクはまだSEOに効果的ですか？",
